...
// Database
import Database_Rewardsconverterapp_db from "./Database_Rewardsconverterapp_db.js";

// Controllers
import UserController from "../controllers/Rewardsconverterapp_db/UserController";
import RewardsconverterappController from "../controllers/Rewardsconverterapp_db/RewardsconverterappController";
...
class Server {
  ...
  async init() {
    ...
    // Start Init Database
		Database_Rewardsconverterapp_db.init();
 // End Init Database
    ...
    // Start Init Controllers
		...
		RewardsconverterappController.init(router);
